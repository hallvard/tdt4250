 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.XmlQuestion#getXml <em>Xml</em>}</li>
 * </ul>
 *
 * @see no.hal.quiz.QuizPackage#getXmlQuestion()
 * @model
 * @generated
 */
public interface XmlQuestion extends Question {
	 ...
	 * @see #setXml(Xml)
	 * @see no.hal.quiz.QuizPackage#getXmlQuestion_Xml()
	...
	/**
	 * Sets the value of the '{@link no.hal.quiz.XmlQuestion#getXml <em>Xml</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
