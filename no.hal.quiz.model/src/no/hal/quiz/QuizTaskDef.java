 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.QuizTaskDef#getQuizParts <em>Quiz Parts</em>}</li>
 *   <li>{@link no.hal.quiz.QuizTaskDef#getCorrectNeeded <em>Correct Needed</em>}</li>
 *   <li>{@link no.hal.quiz.QuizTaskDef#getAttemptsAllowed <em>Attempts Allowed</em>}</li>
 * </ul>
 *
 * @see no.hal.quiz.ModelPackage#getQuizTaskDef()
 * @model
 * @generated
 */
public interface QuizTaskDef extends TaskDef {
	 ...
	 * @see no.hal.quiz.ModelPackage#getQuizTaskDef_QuizParts()
	 * @model
	 * @generated
	 */
	 ...
	 * @see no.hal.quiz.ModelPackage#getQuizTaskDef_CorrectNeeded()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link no.hal.quiz.QuizTaskDef#getCorrectNeeded <em>Correct Needed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see no.hal.quiz.ModelPackage#getQuizTaskDef_AttemptsAllowed()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link no.hal.quiz.QuizTaskDef#getAttemptsAllowed <em>Attempts Allowed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
