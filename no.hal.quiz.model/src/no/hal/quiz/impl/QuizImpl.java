 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.impl.QuizImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.hal.quiz.impl.QuizImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link no.hal.quiz.impl.QuizImpl#getParts <em>Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuizImpl extends MinimalEObjectImpl.Container implements Quiz {
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.QUIZ__TITLE, oldTitle, title));
	}
