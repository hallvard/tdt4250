 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.impl.StringQuestionImpl#getQuestion <em>Question</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringQuestionImpl extends QuestionImpl implements StringQuestion {
	...
	protected EClass eStaticClass() {
		return QuizPackage.Literals.STRING_QUESTION;
	}
	...
	public void setQuestion(String newQuestion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.STRING_QUESTION__QUESTION, oldQuestion, question));
	}
