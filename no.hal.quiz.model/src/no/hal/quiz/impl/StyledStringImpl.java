 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.impl.StyledStringImpl#getCharStyle <em>Char Style</em>}</li>
 *   <li>{@link no.hal.quiz.impl.StyledStringImpl#getEffectiveCharStyle <em>Effective Char Style</em>}</li>
 *   <li>{@link no.hal.quiz.impl.StyledStringImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link no.hal.quiz.impl.StyledStringImpl#getStyledString <em>Styled String</em>}</li>
 *   <li>{@link no.hal.quiz.impl.StyledStringImpl#getSuffix <em>Suffix</em>}</li>
 * </ul>
 *
 * @generated
 */
