 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.impl.BooleanAnswerImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanAnswerImpl extends SimpleAnswerImpl<Boolean> implements BooleanAnswer {
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.BOOLEAN_ANSWER__VALUE, oldValue, value));
	}
