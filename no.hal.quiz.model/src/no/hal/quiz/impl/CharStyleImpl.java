 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getItalic <em>Italic</em>}</li>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getBold <em>Bold</em>}</li>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getSize <em>Size</em>}</li>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getForeground <em>Foreground</em>}</li>
 *   <li>{@link no.hal.quiz.impl.CharStyleImpl#getBackground <em>Background</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharStyleImpl extends MinimalEObjectImpl.Container implements CharStyle {
	...
	public void setItalic(Boolean newItalic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__ITALIC, oldItalic, italic));
	}
	...
	public void setBold(Boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__BOLD, oldBold, bold));
	}
	...
	public void setSize(float newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__SIZE, oldSize, size));
	}
	...
	public void setFamily(String newFamily) {
		...
		family = newFamily;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__FAMILY, oldFamily, family));
	}
	...
	public void setForeground(RGB newForeground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__FOREGROUND, oldForeground, foreground));
	}
	...
	public void setBackground(RGB newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QuizPackage.CHAR_STYLE__BACKGROUND, oldBackground, background));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QuizPackage.CHAR_STYLE__ITALIC:
				return getItalic();
			case QuizPackage.CHAR_STYLE__BOLD:
				return getBold();
			case QuizPackage.CHAR_STYLE__SIZE:
				return getSize();
			case QuizPackage.CHAR_STYLE__FAMILY:
				return getFamily();
			case QuizPackage.CHAR_STYLE__FOREGROUND:
				return getForeground();
			case QuizPackage.CHAR_STYLE__BACKGROUND:
