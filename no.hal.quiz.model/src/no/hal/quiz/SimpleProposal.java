 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.quiz.SimpleProposal#getProposal <em>Proposal</em>}</li>
 * </ul>
 *
 * @see no.hal.quiz.QuizPackage#getSimpleProposal()
 * @model
 * @generated
 */
public interface SimpleProposal<A extends SimpleAnswer<?>> extends Proposal<A> {
	 ...
	 * @see no.hal.quiz.QuizPackage#getSimpleProposal_Proposal()
	 * @model
	 * @generated
	 */
	Object getProposal();
	...
	/**
	 * Sets the value of the '{@link no.hal.quiz.SimpleProposal#getProposal <em>Proposal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
