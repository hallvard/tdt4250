...
import org.w3c.xhtml1.MultipleType;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOptgroup <em>Optgroup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOption <em>Option</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getMultiple <em>Multiple</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnchange <em>Onchange</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.SelectTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectTypeImpl extends EObjectImpl implements SelectType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getSelectType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Xhtml1Package.SELECT_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<OptgroupType> getOptgroup() {
		return getGroup().list(Xhtml1Package.eINSTANCE.getSelectType_Optgroup());
	}
	...
	public EList<OptionType> getOption() {
		return getGroup().list(Xhtml1Package.eINSTANCE.getSelectType_Option());
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.SELECT_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setDisabled(DisabledType newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.SELECT_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setMultiple(MultipleType newMultiple) {
		...
		multipleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__MULTIPLE, oldMultiple, multiple, !oldMultipleESet));
	}
	...
	public void unsetMultiple() {
		...
		multipleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.SELECT_TYPE__MULTIPLE, oldMultiple, MULTIPLE_EDEFAULT, oldMultipleESet));
	}
	...
	public void setName(Object newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__NAME, oldName, name));
	}
	...
	public void setOnblur(String newOnblur) {
		...
		onblur = newOnblur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONBLUR, oldOnblur, onblur));
	}
	...
	public void setOnchange(String newOnchange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONCHANGE, oldOnchange, onchange));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnfocus(String newOnfocus) {
		...
		onfocus = newOnfocus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONFOCUS, oldOnfocus, onfocus));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setSize(BigInteger newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__SIZE, oldSize, size));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTabindex(BigInteger newTabindex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__TABINDEX, oldTabindex, tabindex));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.SELECT_TYPE__TITLE, oldTitle, title));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xhtml1Package.SELECT_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Xhtml1Package.SELECT_TYPE__OPTGROUP:
				return ((InternalEList<?>)getOptgroup()).basicRemove(otherEnd, msgs);
			case Xhtml1Package.SELECT_TYPE__OPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Xhtml1Package.SELECT_TYPE__OPTION:
				return getOption();
			case Xhtml1Package.SELECT_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.SELECT_TYPE__DIR:
				return getDir();
			case Xhtml1Package.SELECT_TYPE__DISABLED:
				return getDisabled();
			case Xhtml1Package.SELECT_TYPE__ID:
				return getId();
			case Xhtml1Package.SELECT_TYPE__LANG:
				return getLang();
			case Xhtml1Package.SELECT_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.SELECT_TYPE__MULTIPLE:
				return getMultiple();
			case Xhtml1Package.SELECT_TYPE__NAME:
				return getName();
			case Xhtml1Package.SELECT_TYPE__ONBLUR:
				return getOnblur();
			case Xhtml1Package.SELECT_TYPE__ONCHANGE:
				return getOnchange();
			case Xhtml1Package.SELECT_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.SELECT_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.SELECT_TYPE__ONFOCUS:
				return getOnfocus();
			case Xhtml1Package.SELECT_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.SELECT_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.SELECT_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.SELECT_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.SELECT_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.SELECT_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.SELECT_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.SELECT_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.SELECT_TYPE__SIZE:
				return getSize();
			case Xhtml1Package.SELECT_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.SELECT_TYPE__TABINDEX:
				return getTabindex();
			case Xhtml1Package.SELECT_TYPE__TITLE:
				return getTitle();
		}
