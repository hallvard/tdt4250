...
import org.w3c.xhtml1.TypeType;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ButtonTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ButtonTypeImpl extends ButtonContentImpl implements ButtonType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getButtonType();
	}
	...
	public void setAccesskey(String newAccesskey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ACCESSKEY, oldAccesskey, accesskey));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.BUTTON_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setDisabled(DisabledType newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.BUTTON_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setName(Object newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__NAME, oldName, name));
	}
	...
	public void setOnblur(String newOnblur) {
		...
		onblur = newOnblur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONBLUR, oldOnblur, onblur));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnfocus(String newOnfocus) {
		...
		onfocus = newOnfocus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONFOCUS, oldOnfocus, onfocus));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTabindex(BigInteger newTabindex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__TABINDEX, oldTabindex, tabindex));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(TypeType newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.BUTTON_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.BUTTON_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.BUTTON_TYPE__ACCESSKEY:
				return getAccesskey();
			case Xhtml1Package.BUTTON_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.BUTTON_TYPE__DIR:
				return getDir();
			case Xhtml1Package.BUTTON_TYPE__DISABLED:
				return getDisabled();
			case Xhtml1Package.BUTTON_TYPE__ID:
				return getId();
			case Xhtml1Package.BUTTON_TYPE__LANG:
				return getLang();
			case Xhtml1Package.BUTTON_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.BUTTON_TYPE__NAME:
				return getName();
			case Xhtml1Package.BUTTON_TYPE__ONBLUR:
				return getOnblur();
			case Xhtml1Package.BUTTON_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.BUTTON_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.BUTTON_TYPE__ONFOCUS:
				return getOnfocus();
			case Xhtml1Package.BUTTON_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.BUTTON_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.BUTTON_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.BUTTON_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.BUTTON_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.BUTTON_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.BUTTON_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.BUTTON_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.BUTTON_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.BUTTON_TYPE__TABINDEX:
				return getTabindex();
			case Xhtml1Package.BUTTON_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.BUTTON_TYPE__TYPE:
				return getType();
			case Xhtml1Package.BUTTON_TYPE__VALUE:
				return getValue();
		}
