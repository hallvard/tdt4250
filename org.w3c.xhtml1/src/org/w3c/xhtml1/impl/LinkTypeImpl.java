 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getCharset <em>Charset</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getHreflang <em>Hreflang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getMedia <em>Media</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getRev <em>Rev</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.LinkTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkTypeImpl extends EObjectImpl implements LinkType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getLinkType();
	}
	...
	public void setCharset(String newCharset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__CHARSET, oldCharset, charset));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.LINK_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__HREF, oldHref, href));
	}
	...
	public void setHreflang(String newHreflang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__HREFLANG, oldHreflang, hreflang));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setMedia(String newMedia) {
		...
		media = newMedia;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__MEDIA, oldMedia, media));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setRel(List<String> newRel) {
		...
		rel = newRel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__REL, oldRel, rel));
	}
	...
	public void setRev(List<String> newRev) {
		...
		rev = newRev;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__REV, oldRev, rev));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.LINK_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.LINK_TYPE__CHARSET:
				return getCharset();
			case Xhtml1Package.LINK_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.LINK_TYPE__DIR:
				return getDir();
			case Xhtml1Package.LINK_TYPE__HREF:
				return getHref();
			case Xhtml1Package.LINK_TYPE__HREFLANG:
				return getHreflang();
			case Xhtml1Package.LINK_TYPE__ID:
				return getId();
			case Xhtml1Package.LINK_TYPE__LANG:
				return getLang();
			case Xhtml1Package.LINK_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.LINK_TYPE__MEDIA:
				return getMedia();
			case Xhtml1Package.LINK_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.LINK_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.LINK_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.LINK_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.LINK_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.LINK_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.LINK_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.LINK_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.LINK_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.LINK_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.LINK_TYPE__REL:
				return getRel();
			case Xhtml1Package.LINK_TYPE__REV:
				return getRev();
			case Xhtml1Package.LINK_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.LINK_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.LINK_TYPE__TYPE:
				return getType();
		}
