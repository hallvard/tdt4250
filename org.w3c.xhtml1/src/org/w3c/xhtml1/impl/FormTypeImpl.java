...
import org.w3c.xhtml1.MethodType;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getAccept <em>Accept</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getAcceptCharset <em>Accept Charset</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getEnctype <em>Enctype</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnreset <em>Onreset</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getOnsubmit <em>Onsubmit</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.FormTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FormTypeImpl extends FormContentImpl implements FormType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getFormType();
	}
	...
	public void setAccept(String newAccept) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ACCEPT, oldAccept, accept));
	}
	...
	public void setAcceptCharset(String newAcceptCharset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ACCEPT_CHARSET, oldAcceptCharset, acceptCharset));
	}
	...
	public void setAction(String newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ACTION, oldAction, action));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.FORM_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setEnctype(String newEnctype) {
		...
		enctypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ENCTYPE, oldEnctype, enctype, !oldEnctypeESet));
	}
	...
	public void unsetEnctype() {
		...
		enctypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.FORM_TYPE__ENCTYPE, oldEnctype, ENCTYPE_EDEFAULT, oldEnctypeESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setMethod(MethodType newMethod) {
		...
		methodESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__METHOD, oldMethod, method, !oldMethodESet));
	}
	...
	public void unsetMethod() {
		...
		methodESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.FORM_TYPE__METHOD, oldMethod, METHOD_EDEFAULT, oldMethodESet));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setOnreset(String newOnreset) {
		...
		onreset = newOnreset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONRESET, oldOnreset, onreset));
	}
	...
	public void setOnsubmit(String newOnsubmit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__ONSUBMIT, oldOnsubmit, onsubmit));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.FORM_TYPE__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.FORM_TYPE__ACCEPT:
				return getAccept();
			case Xhtml1Package.FORM_TYPE__ACCEPT_CHARSET:
				return getAcceptCharset();
			case Xhtml1Package.FORM_TYPE__ACTION:
				return getAction();
			case Xhtml1Package.FORM_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.FORM_TYPE__DIR:
				return getDir();
			case Xhtml1Package.FORM_TYPE__ENCTYPE:
				return getEnctype();
			case Xhtml1Package.FORM_TYPE__ID:
				return getId();
			case Xhtml1Package.FORM_TYPE__LANG:
				return getLang();
			case Xhtml1Package.FORM_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.FORM_TYPE__METHOD:
				return getMethod();
			case Xhtml1Package.FORM_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.FORM_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.FORM_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.FORM_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.FORM_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.FORM_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.FORM_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.FORM_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.FORM_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.FORM_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.FORM_TYPE__ONRESET:
				return getOnreset();
			case Xhtml1Package.FORM_TYPE__ONSUBMIT:
				return getOnsubmit();
			case Xhtml1Package.FORM_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.FORM_TYPE__TITLE:
				return getTitle();
		}
