 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getCharset <em>Charset</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getCoords <em>Coords</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getHreflang <em>Hreflang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getRev <em>Rev</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ATypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ATypeImpl extends AContentImpl implements AType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getAType();
	}
	...
	public void setAccesskey(String newAccesskey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ACCESSKEY, oldAccesskey, accesskey));
	}
	...
	public void setCharset(String newCharset) {
		...
		charset = newCharset;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__CHARSET, oldCharset, charset));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__CLASS, oldClass, class_));
	}
	...
	public void setCoords(String newCoords) {
		...
		coords = newCoords;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__COORDS, oldCoords, coords));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.ATYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__HREF, oldHref, href));
	}
	...
	public void setHreflang(String newHreflang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__HREFLANG, oldHreflang, hreflang));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__NAME, oldName, name));
	}
	...
	public void setOnblur(String newOnblur) {
		...
		onblur = newOnblur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONBLUR, oldOnblur, onblur));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnfocus(String newOnfocus) {
		...
		onfocus = newOnfocus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONFOCUS, oldOnfocus, onfocus));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setRel(List<String> newRel) {
		...
		rel = newRel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__REL, oldRel, rel));
	}
	...
	public void setRev(List<String> newRev) {
		...
		rev = newRev;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__REV, oldRev, rev));
	}
	...
	public void setShape(Shape newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.ATYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__STYLE, oldStyle, style));
	}
	...
	public void setTabindex(BigInteger newTabindex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__TABINDEX, oldTabindex, tabindex));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.ATYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.ATYPE__ACCESSKEY:
				return getAccesskey();
			case Xhtml1Package.ATYPE__CHARSET:
				return getCharset();
			case Xhtml1Package.ATYPE__CLASS:
				return getClass_();
			case Xhtml1Package.ATYPE__COORDS:
				return getCoords();
			case Xhtml1Package.ATYPE__DIR:
				return getDir();
			case Xhtml1Package.ATYPE__HREF:
				return getHref();
			case Xhtml1Package.ATYPE__HREFLANG:
				return getHreflang();
			case Xhtml1Package.ATYPE__ID:
				return getId();
			case Xhtml1Package.ATYPE__LANG:
				return getLang();
			case Xhtml1Package.ATYPE__LANG1:
				return getLang1();
			case Xhtml1Package.ATYPE__NAME:
				return getName();
			case Xhtml1Package.ATYPE__ONBLUR:
				return getOnblur();
			case Xhtml1Package.ATYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.ATYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.ATYPE__ONFOCUS:
				return getOnfocus();
			case Xhtml1Package.ATYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.ATYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.ATYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.ATYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.ATYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.ATYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.ATYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.ATYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.ATYPE__REL:
				return getRel();
			case Xhtml1Package.ATYPE__REV:
				return getRev();
			case Xhtml1Package.ATYPE__SHAPE:
				return getShape();
			case Xhtml1Package.ATYPE__STYLE:
				return getStyle();
			case Xhtml1Package.ATYPE__TABINDEX:
				return getTabindex();
			case Xhtml1Package.ATYPE__TITLE:
				return getTitle();
			case Xhtml1Package.ATYPE__TYPE:
				return getType();
		}
