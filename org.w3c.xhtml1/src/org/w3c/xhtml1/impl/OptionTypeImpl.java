...
import org.w3c.xhtml1.SelectedType;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getSelected <em>Selected</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.OptionTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OptionTypeImpl extends EObjectImpl implements OptionType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getOptionType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, Xhtml1Package.OPTION_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.OPTION_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setDisabled(DisabledType newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.OPTION_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ID, oldId, id));
	}
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__LABEL, oldLabel, label));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setSelected(SelectedType newSelected) {
		...
		selectedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__SELECTED, oldSelected, selected, !oldSelectedESet));
	}
	...
	public void unsetSelected() {
		...
		selectedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.OPTION_TYPE__SELECTED, oldSelected, SELECTED_EDEFAULT, oldSelectedESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.OPTION_TYPE__VALUE, oldValue, value));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xhtml1Package.OPTION_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Xhtml1Package.OPTION_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.OPTION_TYPE__DIR:
				return getDir();
			case Xhtml1Package.OPTION_TYPE__DISABLED:
				return getDisabled();
			case Xhtml1Package.OPTION_TYPE__ID:
				return getId();
			case Xhtml1Package.OPTION_TYPE__LABEL:
				return getLabel();
			case Xhtml1Package.OPTION_TYPE__LANG:
				return getLang();
			case Xhtml1Package.OPTION_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.OPTION_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.OPTION_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.OPTION_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.OPTION_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.OPTION_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.OPTION_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.OPTION_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.OPTION_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.OPTION_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.OPTION_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.OPTION_TYPE__SELECTED:
				return getSelected();
			case Xhtml1Package.OPTION_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.OPTION_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.OPTION_TYPE__VALUE:
				return getValue();
		}
