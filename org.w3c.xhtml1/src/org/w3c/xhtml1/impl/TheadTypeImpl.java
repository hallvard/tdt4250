 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TheadTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TheadTypeImpl extends EObjectImpl implements TheadType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getTheadType();
	}
	...
	public EList<TrType> getTr() {
		if (tr == null) {
			tr = new EObjectContainmentEList<TrType>(TrType.class, this, Xhtml1Package.THEAD_TYPE__TR);
		}
		return tr;
	}
	...
	public void setAlign(AlignType newAlign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.THEAD_TYPE__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setChar(String newChar) {
		...
		char_ = newChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__CHAR, oldChar, char_));
	}
	...
	public void setCharoff(String newCharoff) {
		...
		charoff = newCharoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__CHAROFF, oldCharoff, charoff));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.THEAD_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValign(ValignType newValign) {
		...
		valignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.THEAD_TYPE__VALIGN, oldValign, valign, !oldValignESet));
	}
	...
	public void unsetValign() {
		...
		valignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.THEAD_TYPE__VALIGN, oldValign, VALIGN_EDEFAULT, oldValignESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Xhtml1Package.THEAD_TYPE__TR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.THEAD_TYPE__TR:
				return getTr();
			case Xhtml1Package.THEAD_TYPE__ALIGN:
				return getAlign();
			case Xhtml1Package.THEAD_TYPE__CHAR:
				return getChar();
			case Xhtml1Package.THEAD_TYPE__CHAROFF:
				return getCharoff();
			case Xhtml1Package.THEAD_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.THEAD_TYPE__DIR:
				return getDir();
			case Xhtml1Package.THEAD_TYPE__ID:
				return getId();
			case Xhtml1Package.THEAD_TYPE__LANG:
				return getLang();
			case Xhtml1Package.THEAD_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.THEAD_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.THEAD_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.THEAD_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.THEAD_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.THEAD_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.THEAD_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.THEAD_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.THEAD_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.THEAD_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.THEAD_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.THEAD_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.THEAD_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.THEAD_TYPE__VALIGN:
				return getValign();
		}
