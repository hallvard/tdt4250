...
import org.w3c.xhtml1.TFrame;
import org.w3c.xhtml1.TRules;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getCol <em>Col</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getColgroup <em>Colgroup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getThead <em>Thead</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getTfoot <em>Tfoot</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getTbody <em>Tbody</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getTr <em>Tr</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getBorder <em>Border</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getCellpadding <em>Cellpadding</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getCellspacing <em>Cellspacing</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getFrame <em>Frame</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.TableTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableTypeImpl extends EObjectImpl implements TableType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getTableType();
	}
	...
	public NotificationChain basicSetCaption(CaptionType newCaption, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__CAPTION, oldCaption, newCaption);
	...
	public void setCaption(CaptionType newCaption) {
		if (newCaption != caption) {
			...
			if (caption != null)
				msgs = ((InternalEObject)caption).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__CAPTION, null, msgs);
			if (newCaption != null)
				msgs = ((InternalEObject)newCaption).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__CAPTION, null, msgs);
			msgs = basicSetCaption(newCaption, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__CAPTION, newCaption, newCaption));
	}
	...
	public EList<ColType> getCol() {
		if (col == null) {
			col = new EObjectContainmentEList<ColType>(ColType.class, this, Xhtml1Package.TABLE_TYPE__COL);
		}
		return col;
	}
	...
	public EList<ColgroupType> getColgroup() {
		if (colgroup == null) {
			colgroup = new EObjectContainmentEList<ColgroupType>(ColgroupType.class, this, Xhtml1Package.TABLE_TYPE__COLGROUP);
		}
		return colgroup;
	}
	...
	public NotificationChain basicSetThead(TheadType newThead, NotificationChain msgs) {
		...
		thead = newThead;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__THEAD, oldThead, newThead);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThead(TheadType newThead) {
		if (newThead != thead) {
			NotificationChain msgs = null;
			if (thead != null)
				msgs = ((InternalEObject)thead).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__THEAD, null, msgs);
			if (newThead != null)
				msgs = ((InternalEObject)newThead).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__THEAD, null, msgs);
			msgs = basicSetThead(newThead, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__THEAD, newThead, newThead));
	}
	...
	public NotificationChain basicSetTfoot(TfootType newTfoot, NotificationChain msgs) {
		...
		tfoot = newTfoot;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__TFOOT, oldTfoot, newTfoot);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTfoot(TfootType newTfoot) {
		if (newTfoot != tfoot) {
			NotificationChain msgs = null;
			if (tfoot != null)
				msgs = ((InternalEObject)tfoot).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__TFOOT, null, msgs);
			if (newTfoot != null)
				msgs = ((InternalEObject)newTfoot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xhtml1Package.TABLE_TYPE__TFOOT, null, msgs);
			msgs = basicSetTfoot(newTfoot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__TFOOT, newTfoot, newTfoot));
	}
	...
	public EList<TbodyType> getTbody() {
		if (tbody == null) {
			tbody = new EObjectContainmentEList<TbodyType>(TbodyType.class, this, Xhtml1Package.TABLE_TYPE__TBODY);
		}
		return tbody;
	}
	...
	public EList<TrType> getTr() {
		if (tr == null) {
			tr = new EObjectContainmentEList<TrType>(TrType.class, this, Xhtml1Package.TABLE_TYPE__TR);
		}
		return tr;
	}
	...
	public void setBorder(BigInteger newBorder) {
		...
		border = newBorder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__BORDER, oldBorder, border));
	}
	...
	public void setCellpadding(String newCellpadding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__CELLPADDING, oldCellpadding, cellpadding));
	}
	...
	public void setCellspacing(String newCellspacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__CELLSPACING, oldCellspacing, cellspacing));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TABLE_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setFrame(TFrame newFrame) {
		...
		frameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
	}
	...
	public void unsetFrame() {
		...
		frameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TABLE_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setRules(TRules newRules) {
		...
		rulesESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__RULES, oldRules, rules, !oldRulesESet));
	}
	...
	public void unsetRules() {
		...
		rulesESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TABLE_TYPE__RULES, oldRules, RULES_EDEFAULT, oldRulesESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setSummary(String newSummary) {
		...
		summary = newSummary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__SUMMARY, oldSummary, summary));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TABLE_TYPE__WIDTH, oldWidth, width));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Xhtml1Package.TABLE_TYPE__TR:
				return getTr();
			case Xhtml1Package.TABLE_TYPE__BORDER:
				return getBorder();
			case Xhtml1Package.TABLE_TYPE__CELLPADDING:
				return getCellpadding();
			case Xhtml1Package.TABLE_TYPE__CELLSPACING:
				return getCellspacing();
			case Xhtml1Package.TABLE_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.TABLE_TYPE__DIR:
				return getDir();
			case Xhtml1Package.TABLE_TYPE__FRAME:
				return getFrame();
			case Xhtml1Package.TABLE_TYPE__ID:
				return getId();
			case Xhtml1Package.TABLE_TYPE__LANG:
				return getLang();
			case Xhtml1Package.TABLE_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.TABLE_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.TABLE_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.TABLE_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.TABLE_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.TABLE_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.TABLE_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.TABLE_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.TABLE_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.TABLE_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.TABLE_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.TABLE_TYPE__RULES:
				return getRules();
			case Xhtml1Package.TABLE_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.TABLE_TYPE__SUMMARY:
				return getSummary();
			case Xhtml1Package.TABLE_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.TABLE_TYPE__WIDTH:
				return getWidth();
		}
