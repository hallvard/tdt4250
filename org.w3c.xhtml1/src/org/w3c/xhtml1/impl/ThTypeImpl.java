 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getAbbr1 <em>Abbr1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getAxis <em>Axis</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getChar <em>Char</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getCharoff <em>Charoff</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getColspan <em>Colspan</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getRowspan <em>Rowspan</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.ThTypeImpl#getValign <em>Valign</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThTypeImpl extends FlowImpl implements ThType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getThType();
	}
	...
	public void setAbbr1(String newAbbr1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ABBR1, oldAbbr1, abbr1));
	}
	...
	public void setAlign(AlignType newAlign) {
		...
		alignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ALIGN, oldAlign, align, !oldAlignESet));
	}
	...
	public void unsetAlign() {
		...
		alignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__ALIGN, oldAlign, ALIGN_EDEFAULT, oldAlignESet));
	}
	...
	public void setAxis(Object newAxis) {
		...
		axis = newAxis;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__AXIS, oldAxis, axis));
	}
	...
	public void setChar(String newChar) {
		...
		char_ = newChar;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__CHAR, oldChar, char_));
	}
	...
	public void setCharoff(String newCharoff) {
		...
		charoff = newCharoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__CHAROFF, oldCharoff, charoff));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setColspan(BigInteger newColspan) {
		...
		colspanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__COLSPAN, oldColspan, colspan, !oldColspanESet));
	}
	...
	public void unsetColspan() {
		...
		colspanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__COLSPAN, oldColspan, COLSPAN_EDEFAULT, oldColspanESet));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHeaders(List<String> newHeaders) {
		...
		headers = newHeaders;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__HEADERS, oldHeaders, headers));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setRowspan(BigInteger newRowspan) {
		...
		rowspanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__ROWSPAN, oldRowspan, rowspan, !oldRowspanESet));
	}
	...
	public void unsetRowspan() {
		...
		rowspanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__ROWSPAN, oldRowspan, ROWSPAN_EDEFAULT, oldRowspanESet));
	}
	...
	public void setScope(Scope newScope) {
		...
		scopeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__SCOPE, oldScope, scope, !oldScopeESet));
	}
	...
	public void unsetScope() {
		...
		scopeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__SCOPE, oldScope, SCOPE_EDEFAULT, oldScopeESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValign(ValignType newValign) {
		...
		valignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.TH_TYPE__VALIGN, oldValign, valign, !oldValignESet));
	}
	...
	public void unsetValign() {
		...
		valignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.TH_TYPE__VALIGN, oldValign, VALIGN_EDEFAULT, oldValignESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.TH_TYPE__ABBR1:
				return getAbbr1();
			case Xhtml1Package.TH_TYPE__ALIGN:
				return getAlign();
			case Xhtml1Package.TH_TYPE__AXIS:
				return getAxis();
			case Xhtml1Package.TH_TYPE__CHAR:
				return getChar();
			case Xhtml1Package.TH_TYPE__CHAROFF:
				return getCharoff();
			case Xhtml1Package.TH_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.TH_TYPE__COLSPAN:
				return getColspan();
			case Xhtml1Package.TH_TYPE__DIR:
				return getDir();
			case Xhtml1Package.TH_TYPE__HEADERS:
				return getHeaders();
			case Xhtml1Package.TH_TYPE__ID:
				return getId();
			case Xhtml1Package.TH_TYPE__LANG:
				return getLang();
			case Xhtml1Package.TH_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.TH_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.TH_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.TH_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.TH_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.TH_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.TH_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.TH_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.TH_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.TH_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.TH_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.TH_TYPE__ROWSPAN:
				return getRowspan();
			case Xhtml1Package.TH_TYPE__SCOPE:
				return getScope();
			case Xhtml1Package.TH_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.TH_TYPE__TITLE:
				return getTitle();
			case Xhtml1Package.TH_TYPE__VALIGN:
				return getValign();
		}
