...
import org.w3c.xhtml1.NohrefType;
 ...
 * <ul>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getAccesskey <em>Accesskey</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getCoords <em>Coords</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getLang1 <em>Lang1</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getNohref <em>Nohref</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnblur <em>Onblur</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnclick <em>Onclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOndblclick <em>Ondblclick</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnfocus <em>Onfocus</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnkeydown <em>Onkeydown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnkeypress <em>Onkeypress</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnkeyup <em>Onkeyup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnmousedown <em>Onmousedown</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnmousemove <em>Onmousemove</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnmouseout <em>Onmouseout</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnmouseover <em>Onmouseover</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getOnmouseup <em>Onmouseup</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getTabindex <em>Tabindex</em>}</li>
 *   <li>{@link org.w3c.xhtml1.impl.AreaTypeImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AreaTypeImpl extends EObjectImpl implements AreaType {
	...
	protected EClass eStaticClass() {
		return Xhtml1Package.eINSTANCE.getAreaType();
	}
	...
	public void setAccesskey(String newAccesskey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ACCESSKEY, oldAccesskey, accesskey));
	}
	...
	public void setAlt(String newAlt) {
		...
		alt = newAlt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ALT, oldAlt, alt));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setCoords(String newCoords) {
		...
		coords = newCoords;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__COORDS, oldCoords, coords));
	}
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.AREA_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(String newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setNohref(NohrefType newNohref) {
		...
		nohrefESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__NOHREF, oldNohref, nohref, !oldNohrefESet));
	}
	...
	public void unsetNohref() {
		...
		nohrefESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.AREA_TYPE__NOHREF, oldNohref, NOHREF_EDEFAULT, oldNohrefESet));
	}
	...
	public void setOnblur(String newOnblur) {
		...
		onblur = newOnblur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONBLUR, oldOnblur, onblur));
	}
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnfocus(String newOnfocus) {
		...
		onfocus = newOnfocus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONFOCUS, oldOnfocus, onfocus));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public void setShape(Shape newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Xhtml1Package.AREA_TYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setTabindex(BigInteger newTabindex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__TABINDEX, oldTabindex, tabindex));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xhtml1Package.AREA_TYPE__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xhtml1Package.AREA_TYPE__ACCESSKEY:
				return getAccesskey();
			case Xhtml1Package.AREA_TYPE__ALT:
				return getAlt();
			case Xhtml1Package.AREA_TYPE__CLASS:
				return getClass_();
			case Xhtml1Package.AREA_TYPE__COORDS:
				return getCoords();
			case Xhtml1Package.AREA_TYPE__DIR:
				return getDir();
			case Xhtml1Package.AREA_TYPE__HREF:
				return getHref();
			case Xhtml1Package.AREA_TYPE__ID:
				return getId();
			case Xhtml1Package.AREA_TYPE__LANG:
				return getLang();
			case Xhtml1Package.AREA_TYPE__LANG1:
				return getLang1();
			case Xhtml1Package.AREA_TYPE__NOHREF:
				return getNohref();
			case Xhtml1Package.AREA_TYPE__ONBLUR:
				return getOnblur();
			case Xhtml1Package.AREA_TYPE__ONCLICK:
				return getOnclick();
			case Xhtml1Package.AREA_TYPE__ONDBLCLICK:
				return getOndblclick();
			case Xhtml1Package.AREA_TYPE__ONFOCUS:
				return getOnfocus();
			case Xhtml1Package.AREA_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case Xhtml1Package.AREA_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case Xhtml1Package.AREA_TYPE__ONKEYUP:
				return getOnkeyup();
			case Xhtml1Package.AREA_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case Xhtml1Package.AREA_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case Xhtml1Package.AREA_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case Xhtml1Package.AREA_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case Xhtml1Package.AREA_TYPE__ONMOUSEUP:
				return getOnmouseup();
			case Xhtml1Package.AREA_TYPE__SHAPE:
				return getShape();
			case Xhtml1Package.AREA_TYPE__STYLE:
				return getStyle();
			case Xhtml1Package.AREA_TYPE__TABINDEX:
				return getTabindex();
			case Xhtml1Package.AREA_TYPE__TITLE:
				return getTitle();
		}
