 ...
 * generated by Xtext
 */
package no.hal.pg.quiz.xtext.formatting;
...
public class XQuizFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  ...
  protected void configureFormatting(final FormattingConfig c) {
    ...
    List<Keyword> _findKeywords = this._xQuizGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._xQuizGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._xQuizGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._xQuizGrammarAccess.getML_COMMENTRule();
