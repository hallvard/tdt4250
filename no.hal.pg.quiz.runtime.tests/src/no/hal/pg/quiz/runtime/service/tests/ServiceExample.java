...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>service</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.service"));
				QuizTaskService root = ServiceFactory.eINSTANCE.createQuizTaskService();
