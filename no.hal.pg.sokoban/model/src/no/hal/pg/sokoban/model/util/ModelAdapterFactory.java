...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch =
		new ModelSwitch<Adapter>() {
			@Override
			public Adapter caseSokobanTaskDef(SokobanTaskDef object) {
				return createSokobanTaskDefAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.pg.sokoban.model.SokobanTaskDef <em>Sokoban Task Def</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSokobanTaskDefAdapter() {
		return null;
	}
