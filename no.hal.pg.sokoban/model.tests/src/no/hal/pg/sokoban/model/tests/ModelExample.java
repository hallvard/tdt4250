...
import no.hal.pg.sokoban.model.util.ModelResourceFactoryImpl;
...
public class ModelExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.pg-sok"));
				SokobanTaskDef root = ModelFactory.eINSTANCE.createSokobanTaskDef();
