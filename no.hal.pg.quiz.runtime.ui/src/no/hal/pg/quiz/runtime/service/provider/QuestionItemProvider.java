...
/**
 * This is the item provider adapter for a {@link no.hal.pg.quiz.runtime.service.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_kind_feature", "_UI_Question_type"),
				 ServicePackage.Literals.QUESTION__KIND,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Num Choices feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumChoicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_numChoices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_numChoices_feature", "_UI_Question_type"),
				 ServicePackage.Literals.QUESTION__NUM_CHOICES,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Qid feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addQidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_qid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_qid_feature", "_UI_Question_type"),
				 ServicePackage.Literals.QUESTION__QID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicePackage.Literals.QUESTION__OPTIONS);
		}
	...
	public String getText(Object object) {
		AnswerKind labelValue = ((Question)object).getKind();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.QUESTION__OPTIONS,
				 ServiceFactory.eINSTANCE.createAnswer()));
	}
