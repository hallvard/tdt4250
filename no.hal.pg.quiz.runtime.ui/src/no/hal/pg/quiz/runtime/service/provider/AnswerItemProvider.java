...
/**
 * This is the item provider adapter for a {@link no.hal.pg.quiz.runtime.service.Answer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addSelectedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Answer_selected_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Answer_selected_feature", "_UI_Answer_type"),
				 ServicePackage.Literals.ANSWER__SELECTED,
				 true,
				 false,
				 false,
