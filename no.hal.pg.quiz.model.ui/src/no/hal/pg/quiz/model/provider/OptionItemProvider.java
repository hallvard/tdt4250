...
/**
 * This is the item provider adapter for a {@link no.hal.pg.quiz.model.Option} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_correct_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_correct_feature", "_UI_Option_type"),
				 ModelPackage.Literals.OPTION__CORRECT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.OPTION__OPTION);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Option_type") + " " + option.isCorrect();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.OPTION__OPTION,
