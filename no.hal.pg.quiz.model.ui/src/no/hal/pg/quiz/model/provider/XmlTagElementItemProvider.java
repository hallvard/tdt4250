...
/**
 * This is the item provider adapter for a {@link no.hal.pg.quiz.model.XmlTagElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XmlTagElementItemProvider extends XmlElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.XML_TAG_ELEMENT__PRE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.XML_TAG_ELEMENT__END_TAG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.XML_TAG_ELEMENT__START_TAG);
			childrenFeatures.add(ModelPackage.Literals.XML_TAG_ELEMENT__CONTENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.XML_TAG_ELEMENT__START_TAG,
				 ModelFactory.eINSTANCE.createXmlTag()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.XML_TAG_ELEMENT__CONTENTS,
				 ModelFactory.eINSTANCE.createXmlContents()));
	}
