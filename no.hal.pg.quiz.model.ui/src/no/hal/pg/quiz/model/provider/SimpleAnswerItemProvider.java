...
/**
 * This is the item provider adapter for a {@link no.hal.pg.quiz.model.SimpleAnswer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleAnswerItemProvider extends OptionAnswerItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SimpleAnswerItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.SIMPLE_ANSWER__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimpleAnswer.class)) {
			case ModelPackage.SIMPLE_ANSWER__VALUE:
