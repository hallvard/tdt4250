 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.XmlTagElement#getStartTag <em>Start Tag</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.XmlTagElement#getPre <em>Pre</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.XmlTagElement#getContents <em>Contents</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.XmlTagElement#getEndTag <em>End Tag</em>}</li>
 * </ul>
 *
 * @see no.hal.pg.quiz.model.ModelPackage#getXmlTagElement()
...
public interface XmlTagElement extends XmlElement {
	 ...
	 * @see no.hal.pg.quiz.model.ModelPackage#getXmlTagElement_StartTag()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.quiz.model.XmlTagElement#getStartTag <em>Start Tag</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPre(String)
	 * @see no.hal.pg.quiz.model.ModelPackage#getXmlTagElement_Pre()
	 * @model
	 * @generated
	 */
	String getPre();
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.quiz.model.XmlTagElement#getPre <em>Pre</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link no.hal.pg.quiz.model.XmlContents}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see no.hal.pg.quiz.model.ModelPackage#getXmlTagElement_Contents()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see no.hal.pg.quiz.model.ModelPackage#getXmlTagElement_EndTag()
	 * @model
	 * @generated
	 */
	String getEndTag();
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.quiz.model.XmlTagElement#getEndTag <em>End Tag</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
