 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.XmlPIAnswerElement#getAnswer <em>Answer</em>}</li>
 * </ul>
 *
 * @see no.hal.pg.quiz.model.ModelPackage#getXmlPIAnswerElement()
 * @model
 * @generated
 */
public interface XmlPIAnswerElement extends XmlElement {
	 ...
	 * @see no.hal.pg.quiz.model.ModelPackage#getXmlPIAnswerElement_Answer()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.quiz.model.XmlPIAnswerElement#getAnswer <em>Answer</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
