 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.QuizPartRef#getPartRef <em>Part Ref</em>}</li>
 * </ul>
 *
 * @see no.hal.pg.quiz.model.ModelPackage#getQuizPartRef()
 * @model
 * @generated
 */
public interface QuizPartRef extends AbstractQuizPart {
	 ...
	 * @see no.hal.pg.quiz.model.ModelPackage#getQuizPartRef_PartRef()
	 * @model
	 * @generated
	 */
	QuizPart getPartRef();
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.quiz.model.QuizPartRef#getPartRef <em>Part Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
