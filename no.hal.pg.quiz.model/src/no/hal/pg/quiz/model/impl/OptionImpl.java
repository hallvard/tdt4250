 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.impl.OptionImpl#isCorrect <em>Correct</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.impl.OptionImpl#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionImpl extends MinimalEObjectImpl.Container implements Option {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.OPTION;
	}
	...
	public void setCorrect(boolean newCorrect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OPTION__CORRECT, oldCorrect, correct));
	}
	...
	public NotificationChain basicSetOption(OptionAnswer newOption, NotificationChain msgs) {
		...
		option = newOption;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.OPTION__OPTION, oldOption, newOption);
	...
	public void setOption(OptionAnswer newOption) {
		if (newOption != option) {
			...
			if (option != null)
				msgs = ((InternalEObject)option).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.OPTION__OPTION, null, msgs);
			if (newOption != null)
				msgs = ((InternalEObject)newOption).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.OPTION__OPTION, null, msgs);
			msgs = basicSetOption(newOption, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OPTION__OPTION, newOption, newOption));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.OPTION__OPTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.OPTION__CORRECT:
				return isCorrect();
			case ModelPackage.OPTION__OPTION:
				return getOption();
		}
