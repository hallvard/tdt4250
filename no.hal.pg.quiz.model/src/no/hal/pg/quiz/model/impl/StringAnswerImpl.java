 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.impl.StringAnswerImpl#isRegexp <em>Regexp</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.impl.StringAnswerImpl#isIgnoreCase <em>Ignore Case</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringAnswerImpl extends SimpleAnswerImpl<String> implements StringAnswer {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.STRING_ANSWER;
	}
	...
	public void setRegexp(boolean newRegexp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STRING_ANSWER__REGEXP, oldRegexp, regexp));
	}
	...
	public void setIgnoreCase(boolean newIgnoreCase) {
		...
		invalidatePattern();
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STRING_ANSWER__IGNORE_CASE, oldIgnoreCase, ignoreCase));
	}
