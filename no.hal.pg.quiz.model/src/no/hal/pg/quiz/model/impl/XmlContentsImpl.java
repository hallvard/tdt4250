 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.impl.XmlContentsImpl#getElement <em>Element</em>}</li>
 *   <li>{@link no.hal.pg.quiz.model.impl.XmlContentsImpl#getPost <em>Post</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XmlContentsImpl extends MinimalEObjectImpl.Container implements XmlContents {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.XML_CONTENTS;
	}
	...
	public NotificationChain basicSetElement(XmlElement newElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.XML_CONTENTS__ELEMENT, oldElement, newElement);
	...
	public void setElement(XmlElement newElement) {
		if (newElement != element) {
			...
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XML_CONTENTS__ELEMENT, null, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XML_CONTENTS__ELEMENT, null, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XML_CONTENTS__ELEMENT, newElement, newElement));
	}
	...
	public void setPost(String newPost) {
		...
		post = newPost;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XML_CONTENTS__POST, oldPost, post));
	}
