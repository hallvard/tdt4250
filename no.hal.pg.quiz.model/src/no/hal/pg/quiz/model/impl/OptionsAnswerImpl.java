 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.impl.OptionsAnswerImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionsAnswerImpl extends AnswerImpl implements OptionsAnswer {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.OPTIONS_ANSWER;
	}
	...
	public EList<Option> getOptions() {
		if (options == null) {
			options = new EObjectContainmentEList<Option>(Option.class, this, ModelPackage.OPTIONS_ANSWER__OPTIONS);
		}
		return options;
	}
