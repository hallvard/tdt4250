 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.model.impl.XmlPIAnswerElementImpl#getAnswer <em>Answer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XmlPIAnswerElementImpl extends XmlElementImpl implements XmlPIAnswerElement {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.XML_PI_ANSWER_ELEMENT;
	}
	...
	public NotificationChain basicSetAnswer(SimpleAnswer<?> newAnswer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.XML_PI_ANSWER_ELEMENT__ANSWER, oldAnswer, newAnswer);
	...
	public void setAnswer(SimpleAnswer<?> newAnswer) {
		if (newAnswer != answer) {
			...
			if (answer != null)
				msgs = ((InternalEObject)answer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XML_PI_ANSWER_ELEMENT__ANSWER, null, msgs);
			if (newAnswer != null)
				msgs = ((InternalEObject)newAnswer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.XML_PI_ANSWER_ELEMENT__ANSWER, null, msgs);
			msgs = basicSetAnswer(newAnswer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.XML_PI_ANSWER_ELEMENT__ANSWER, newAnswer, newAnswer));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.XML_PI_ANSWER_ELEMENT__ANSWER:
