 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.ra.model.impl.RoleImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.hal.ra.model.impl.RoleImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleImpl extends MinimalEObjectImpl.Container implements Role {
	...
	public void setFactor(double newFactor) {
		...
		factor = newFactor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ROLE__FACTOR, oldFactor, factor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.ROLE__NAME:
				return getName();
			case ModelPackage.ROLE__FACTOR:
				return getFactor();
		}
