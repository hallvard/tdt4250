...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelPackage.DEPARTMENT: return createDepartment();
			case ModelPackage.PERSON: return createPerson();
			case ModelPackage.COURSE: return createCourse();
			case ModelPackage.ROLE: return createRole();
			case ModelPackage.SEMESTER: return createSemester();
			case ModelPackage.COURSE_INSTANCE: return createCourseInstance();
			case ModelPackage.COURSE_ALLOCATION: return createCourseAllocation();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ModelPackage.SEMESTER_YEAR:
				return createSemesterYearFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ModelPackage.SEMESTER_YEAR:
				return convertSemesterYearToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Double createFactorFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public Integer createSemesterYearFromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertSemesterYearToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
