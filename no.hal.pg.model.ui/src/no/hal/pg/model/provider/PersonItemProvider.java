...
/**
 * This is the item provider adapter for a {@link no.hal.pg.model.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIdsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_ids_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_ids_feature", "_UI_Person_type"),
				 ModelPackage.Literals.PERSON__IDS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
