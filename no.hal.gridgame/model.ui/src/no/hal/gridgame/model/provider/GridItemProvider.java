...
/**
 * This is the item provider adapter for a {@link no.hal.gridgame.model.Grid} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_width_feature", "_UI_Grid_type"),
				 ModelPackage.Literals.GRID__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_height_feature", "_UI_Grid_type"),
				 ModelPackage.Literals.GRID__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
