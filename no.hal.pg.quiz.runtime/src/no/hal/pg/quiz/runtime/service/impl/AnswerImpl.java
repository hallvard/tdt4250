 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.quiz.runtime.service.impl.AnswerImpl#getAnswer <em>Answer</em>}</li>
 *   <li>{@link no.hal.pg.quiz.runtime.service.impl.AnswerImpl#isSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnswerImpl extends MinimalEObjectImpl.Container implements Answer {
	...
	protected EClass eStaticClass() {
		return ServicePackage.Literals.ANSWER;
	}
	...
	public void setAnswer(String newAnswer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.ANSWER__ANSWER, oldAnswer, answer));
	}
	...
	public void setSelected(boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.ANSWER__SELECTED, oldSelected, selected));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePackage.ANSWER__ANSWER:
				return getAnswer();
			case ServicePackage.ANSWER__SELECTED:
				return isSelected();
		}
