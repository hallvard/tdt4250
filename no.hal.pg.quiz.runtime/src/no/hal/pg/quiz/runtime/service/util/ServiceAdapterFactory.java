/**
 */
package no.hal.pg.quiz.runtime.service.util;
...
public class ServiceAdapterFactory extends AdapterFactoryImpl {
	...
	protected ServiceSwitch<Adapter> modelSwitch =
		new ServiceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseQAProposalService(QAProposalService object) {
				return createQAProposalServiceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.pg.quiz.runtime.service.QuizTaskService <em>Quiz Task Service</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.pg.quiz.runtime.service.QAProposalService <em>QA Proposal Service</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
