...
/**
 * This is the item provider adapter for a {@link no.hal.quiz.Proposal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProposalItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Proposal_question_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Proposal_question_feature", "_UI_Proposal_type"),
				 QuizPackage.Literals.PROPOSAL__QUESTION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAnswerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Proposal_answer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Proposal_answer_feature", "_UI_Proposal_type"),
				 QuizPackage.Literals.PROPOSAL__ANSWER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Proposal_type");
	}
