...
import no.hal.quiz.checkstyle.CheckstyleFactory;
...
public class CheckstylePackageImpl extends EPackageImpl implements CheckstylePackage {
	 ...
	 * @see no.hal.quiz.checkstyle.CheckstylePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		checkstyleAnswerEClass.getESuperTypes().add(theQuizPackage.getTaskAnswer());
