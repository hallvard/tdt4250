/**
 */
package no.hal.quiz.checkstyle.util;
 ...
 * <!-- end-user-doc -->
 * @see no.hal.quiz.checkstyle.CheckstylePackage
 * @generated
 */
public class CheckstyleSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CheckstylePackage.CHECKSTYLE_ANSWER: {
				CheckstyleAnswer checkstyleAnswer = (CheckstyleAnswer)theEObject;
				T1 result = caseCheckstyleAnswer(checkstyleAnswer);
				if (result == null) result = caseTaskAnswer(checkstyleAnswer);
				if (result == null) result = caseAnswer(checkstyleAnswer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CheckstylePackage.CHECKSTYLE_PROPOSAL: {
				CheckstyleProposal checkstyleProposal = (CheckstyleProposal)theEObject;
				T1 result = caseCheckstyleProposal(checkstyleProposal);
				if (result == null) result = caseTaskProposal(checkstyleProposal);
				if (result == null) result = caseProposal(checkstyleProposal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T1 caseCheckstyleAnswer(CheckstyleAnswer object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseCheckstyleProposal(CheckstyleProposal object) {
		return null;
	}
