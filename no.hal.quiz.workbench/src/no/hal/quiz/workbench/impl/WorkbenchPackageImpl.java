...
import no.hal.quiz.workbench.WorkbenchFactory;
...
public class WorkbenchPackageImpl extends EPackageImpl implements WorkbenchPackage {
	 ...
	 * @see no.hal.quiz.workbench.WorkbenchPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		workbenchTaskAnswerEClass.getESuperTypes().add(theQuizPackage.getTaskAnswer());
		...
		g1 = createEGenericType(theQuizPackage.getTaskProposal());
