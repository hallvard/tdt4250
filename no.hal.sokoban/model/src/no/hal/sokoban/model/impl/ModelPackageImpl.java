...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSokobanGrid_PlayerX(), ecorePackage.getEInt(), "playerX", null, 0, 1, SokobanGrid.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSokobanGrid_PlayerY(), ecorePackage.getEInt(), "playerY", null, 0, 1, SokobanGrid.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEDataType(cellEDataType, no.hal.sokoban.util.Cell.class, "Cell", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
