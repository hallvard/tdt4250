 ...
 * <!-- end-user-doc -->
 * @see no.hal.pg.runtime.http.tests.TestsPackage
 * @generated
 */
public class TestsFactory extends EFactoryImpl {
	 ...
	 * @generated
	 */
	public no.hal.pg.runtime.http.tests.Container createContainer() {
		no.hal.pg.runtime.http.tests.Container container = new no.hal.pg.runtime.http.tests.Container();
		return container;
	}
