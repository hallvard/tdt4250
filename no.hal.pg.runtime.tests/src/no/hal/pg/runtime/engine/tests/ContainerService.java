 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.runtime.engine.tests.ContainerService#getSimple1 <em>Simple1</em>}</li>
 *   <li>{@link no.hal.pg.runtime.engine.tests.ContainerService#getInt1 <em>Int1</em>}</li>
 * </ul>
 *
...
public class ContainerService extends MinimalEObjectImpl.Container implements runtime.Service<no.hal.pg.runtime.engine.tests.Container> {
	 ...
	 * @ordered
	 */
	protected no.hal.pg.runtime.engine.tests.Container context;
	...
	public no.hal.pg.runtime.engine.tests.Container getContext() {
		if (context != null && ((EObject)context).eIsProxy()) {
			...
			context = (no.hal.pg.runtime.engine.tests.Container)eResolveProxy(oldContext);
	 ...
	 * @generated
	 */
	public no.hal.pg.runtime.engine.tests.Container basicGetContext() {
		return context;
	}

	/**
	 * Sets the value of the '{@link no.hal.pg.runtime.engine.tests.ContainerService#getContext <em>Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public void setContext(no.hal.pg.runtime.engine.tests.Container newContext) {
		no.hal.pg.runtime.engine.tests.Container oldContext = context;
		context = newContext;
		if (eNotificationRequired())
	 ...
	 * @see no.hal.pg.runtime.engine.tests.TestsPackage#getContainerService_Simple1()
	 ...
	 * @see #setInt1(int)
	 * @see no.hal.pg.runtime.engine.tests.TestsPackage#getContainerService_Int1()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.runtime.engine.tests.ContainerService#getInt1 <em>Int1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<Simple2> getSimples2(String stringFilter) {
		Collection<Simple2> result = new ArrayList<Simple2>();
		for (Simple2 simple2 : getContext().getSimples2()) {
			if (simple2.getString21().startsWith(stringFilter)) {
				result.add(simple2);
			}
		}
		return new UnmodifiableEList<Simple2>(result.size(), result.toArray());
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TestsPackage.CONTAINER_SERVICE__CONTEXT:
				setContext((no.hal.pg.runtime.engine.tests.Container)newValue);
				return;
			case TestsPackage.CONTAINER_SERVICE__INT1:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case TestsPackage.CONTAINER_SERVICE__CONTEXT:
				setContext((no.hal.pg.runtime.engine.tests.Container)null);
				return;
			case TestsPackage.CONTAINER_SERVICE__INT1:
